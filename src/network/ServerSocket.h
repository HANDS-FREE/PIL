...
class PIL_API ServerSocket: public Socket
...
public:
    ...
    ServerSocket(pi::UInt16 port, int backlog = 64);
        /// Creates a server socket, binds it
    ...
    virtual void bind(pi::UInt16 port, bool reuseAddress = false);
    ...
    virtual void bind6(pi::UInt16 port, bool reuseAddress = false, bool ipV6Only = false);
