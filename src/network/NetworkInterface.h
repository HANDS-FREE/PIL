...
class PIL_API NetworkInterface
...
public:
    ...
    typedef pi::Tuple<IPAddress, IPAddress, IPAddress>   AddressTuple;
...
PIL_API std::ostream& operator<<(std::ostream& os, const pi::NetworkInterface::MACAddress& mac);
