...
class PIL_API StreamSocket: public Socket
...
public:
    ...
    void connect(const SocketAddress& address, const pi::Timespan& timeout);
    ...
    int sendBytes(pi::FIFOBuffer& buffer);
        /// Sends the contents of the given buffer through
    ...
    int receiveBytes(pi::FIFOBuffer& buffer);
        /// Receives data from the socket and stores it
