...
class PIL_API SocketImpl: public pi::RefCountedObject
...
public:
    ...
    virtual void connect(const SocketAddress& address, const pi::Timespan& timeout);
    ...
    virtual void bind6(const SocketAddress& address, bool reuseAddress = false, bool ipV6Only = false);
        ...
        /// a pi::NotImplementedException will be thrown.
    ...
    virtual bool poll(const pi::Timespan& timeout, int mode);
    ...
    virtual void setSendTimeout(const pi::Timespan& timeout);
        /// Sets the send timeout for the socket.

    virtual pi::Timespan getSendTimeout();
    ...
    virtual void setReceiveTimeout(const pi::Timespan& timeout);
        /// Sets the send timeout for the socket.
        ///
        /// On systems that do not support SO_RCVTIMEO, a
        /// workaround using poll() is provided.

    virtual pi::Timespan getReceiveTimeout();
    ...
    void setOption(int level, int option, const pi::Timespan& value);
        /// Sets the socket option specified by level and option
    ...
    virtual void setRawOption(int level, int option, const void* value, pil_socklen_t length);
        /// Sets the socket option specified by level and option
        /// to the given time value.
    ...
    void getOption(int level, int option, pi::Timespan& value);
        /// Returns the value of the socket option
        /// specified by level and option.
    ...
    virtual void getRawOption(int level, int option, void* value, pil_socklen_t& length);
        /// Returns the value of the socket option
        /// specified by level and option.
    ...
    pil_socket_t sockfd() const;
        /// Returns the socket descriptor for the
        /// underlying native socket.

    void ioctl(pil_ioctl_request_t request, int& arg);
        /// A wrapper for the ioctl system call.

    void ioctl(pil_ioctl_request_t request, void* arg);
        /// A wrapper for the ioctl system call.

#if defined(PIL_OS_FAMILY_UNIX)
    int fcntl(pil_fcntl_request_t request);
        /// A wrapper for the fcntl system call.

    int fcntl(pil_fcntl_request_t request, long arg);
        /// A wrapper for the fcntl system call.
#endif
...
protected:
    ...
    SocketImpl(pil_socket_t sockfd);
    ...
    void reset(pil_socket_t fd = PIL_INVALID_SOCKET);
...
private:
    ...
    pil_socket_t _sockfd;
#if defined(PIL_BROKEN_TIMEOUTS)
    pi::Timespan _recvTimeout;
    pi::Timespan _sndTimeout;
#endif
    bool          _blocking;
...
// inlines
//
inline pil_socket_t SocketImpl::sockfd() const
{
    return _sockfd;
}
...
{
    return _sockfd != PIL_INVALID_SOCKET;
}
