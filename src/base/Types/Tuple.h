#ifndef PIL_Tuple_INCLUDED
#define PIL_Tuple_INCLUDED
...
#if defined(_MSC_VER)
#define PIL_TYPEWRAPPER_DEFAULTVALUE(T) TypeWrapper<T>::TYPE()
#else
#define PIL_TYPEWRAPPER_DEFAULTVALUE(T) typename TypeWrapper<T>::TYPE()
#endif
...
struct Tuple
{
    ...
    Tuple(typename TypeWrapper<T0>::CONSTTYPE& t0,
        typename TypeWrapper<T1>::CONSTTYPE& t1 = PIL_TYPEWRAPPER_DEFAULTVALUE(T1),
        typename TypeWrapper<T2>::CONSTTYPE& t2 = PIL_TYPEWRAPPER_DEFAULTVALUE(T2),
        typename TypeWrapper<T3>::CONSTTYPE& t3 = PIL_TYPEWRAPPER_DEFAULTVALUE(T3),
        typename TypeWrapper<T4>::CONSTTYPE& t4 = PIL_TYPEWRAPPER_DEFAULTVALUE(T4),
        typename TypeWrapper<T5>::CONSTTYPE& t5 = PIL_TYPEWRAPPER_DEFAULTVALUE(T5),
        typename TypeWrapper<T6>::CONSTTYPE& t6 = PIL_TYPEWRAPPER_DEFAULTVALUE(T6),
        typename TypeWrapper<T7>::CONSTTYPE& t7 = PIL_TYPEWRAPPER_DEFAULTVALUE(T7),
        typename TypeWrapper<T8>::CONSTTYPE& t8 = PIL_TYPEWRAPPER_DEFAULTVALUE(T8),
        typename TypeWrapper<T9>::CONSTTYPE& t9 = PIL_TYPEWRAPPER_DEFAULTVALUE(T9),
        typename TypeWrapper<T10>::CONSTTYPE& t10 = PIL_TYPEWRAPPER_DEFAULTVALUE(T10),
        typename TypeWrapper<T11>::CONSTTYPE& t11 = PIL_TYPEWRAPPER_DEFAULTVALUE(T11),
        typename TypeWrapper<T12>::CONSTTYPE& t12 = PIL_TYPEWRAPPER_DEFAULTVALUE(T12),
        typename TypeWrapper<T13>::CONSTTYPE& t13 = PIL_TYPEWRAPPER_DEFAULTVALUE(T13),
        typename TypeWrapper<T14>::CONSTTYPE& t14 = PIL_TYPEWRAPPER_DEFAULTVALUE(T14),
        typename TypeWrapper<T15>::CONSTTYPE& t15 = PIL_TYPEWRAPPER_DEFAULTVALUE(T15),
        typename TypeWrapper<T16>::CONSTTYPE& t16 = PIL_TYPEWRAPPER_DEFAULTVALUE(T16),
        typename TypeWrapper<T17>::CONSTTYPE& t17 = PIL_TYPEWRAPPER_DEFAULTVALUE(T17),
        typename TypeWrapper<T18>::CONSTTYPE& t18 = PIL_TYPEWRAPPER_DEFAULTVALUE(T18),
        typename TypeWrapper<T19>::CONSTTYPE& t19 = PIL_TYPEWRAPPER_DEFAULTVALUE(T19)):
